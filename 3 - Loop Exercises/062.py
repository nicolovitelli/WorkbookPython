...
that the discount amounts and the new prices are rounded to 2 decimal places when they are displayed. """
numero = 1
prodotto = "1"
prezzo = 0
while (numero != "0"):
    prodotto = input("Inserisci Prodotto (0 per uscire): ")
    prezzo = int(input("Prezzo (0 per uscire): "))
    numero = prodotto
    if prezzo == 4.95 or prezzo == 9.95 or prezzo == 14.95 or prezzo == 19.95 or prezzo == 24.95:
        prezzo = prezzo * 60 / 100
    elif numero == "0":
        print("Fine della Tabella")
        break
